...
program main
    ...
    *** 1960 base outcomes
	...
	foreach depvar in log_pop log_urbpop share_urbpop {
	    ...
	    run_OLS_int_regression, depvar(chg_`depvar'_91_60) ///
	        baseline_depvar(log_urbpop_1960) ///
	        roads_var(chg_pav_and_grav_86_54) ///
		    trains_var(chg_tot_rails_86_60) ///
		    table_name(OLS_int_chg_`depvar'_91_60_pav_and_grav)
       run_IV_int_regression, depvar(chg_`depvar'_91_60) ///
	        baseline_depvar(log_urbpop_1960) ///
	        roads_var(chg_pav_and_grav_86_54) ///
		    trains_var(chg_tot_rails_86_60) ///
		    table_name(IV_EUC_int_chg_`depvar'_91_60_pav_and_grav) ///
		    instrument_roads(`instrument_roads')
	}
	
    *** 1970 base outcomes
		*** Population outcomes 
	run_OLS_int_regression, depvar(chg_log_pop_91_70) ///
	    baseline_depvar(log_urbpop_1960) ///
	    roads_var(chg_pav_and_grav_86_70) ///
		trains_var(chg_tot_rails_86_70) ///
		table_name(OLS_int_chg_log_pop_91_70_pav_and_grav)
    run_IV_int_regression, depvar(chg_log_pop_91_70) ///
	    baseline_depvar(log_urbpop_1960) ///
	    roads_var(chg_pav_and_grav_86_70) ///
		trains_var(chg_tot_rails_86_70) ///
		table_name(IV_EUC_int_chg_log_pop_91_70_pav_and_grav) ///
		instrument_roads(`instrument_roads')
	...
	foreach depvar in log_agr_labor log_min_labor log_ind_labor ///
		...
		run_OLS_int_regression, depvar(chg_`depvar'_91_70) ///
			baseline_depvar(log_urbpop_1960) ///
			roads_var(chg_pav_and_grav_86_70) ///
			trains_var(chg_tot_rails_86_70) ///
			table_name(OLS_int_chg_`depvar'_91_70_pav_and_grav)

		run_IV_int_regression, depvar(chg_`depvar'_91_70) ///
			baseline_depvar(log_urbpop_1960) ///
			roads_var(chg_pav_and_grav_86_70) ///
			trains_var(chg_tot_rails_86_70) ///
			table_name(IV_EUC_int_chg_`depvar'_91_70_pav_and_grav) ///
			instrument_roads(`instrument_roads')
		}
	...
	**** Labor levels by class of workers
	...
	foreach depvar in log_nsecondary_ed log_ncollege {
		...
		*** Migration levels
	run_OLS_int_regression, depvar(chg_log_nmig5_91_70) ///
		baseline_depvar(log_urbpop_1960) ///
		roads_var(chg_pav_and_grav_86_70) ///
		trains_var(chg_tot_rails_86_70) ///
		table_name(OLS_int_chg_log_nmig5_91_70_pav_and_grav)
		
	run_IV_int_regression, depvar(chg_log_nmig5_91_70) ///
		baseline_depvar(log_urbpop_1960) ///
		roads_var(chg_pav_and_grav_86_70) ///
		trains_var(chg_tot_rails_86_70) ///
		table_name(IV_EUC_int_chg_log_nmig5_91_70_pav_and_grav) ///
		instrument_roads(`instrument_roads')
...
program run_OLS_int_regression
	...
	eststo: qui reg `depvar' `roads_var' `trains_var' c.`roads_var'#c.`trains_var'
